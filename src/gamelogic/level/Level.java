	...
	public Level(Leveldata leveldata) {
		...
		for (int x = 0; x < width; x++) {
			...
			for (int y = 0; y < height; y++) {
				...
				else if(values[x][y] == 1) tiles[x][y] = new SolidTile(xPosition, yPosition, tileSize, tileset.getImage("Solid"), this);
				...
				else if(values[x][y] == 6) tiles[x][y] = new SolidTile(xPosition, yPosition, tileSize, tileset.getImage("Dirt"), this);
				else if(values[x][y] == 7) tiles[x][y] = new SolidTile(xPosition, yPosition, tileSize, tileset.getImage("Gras"), this);
				else if(values[x][y] == 8) enemiesList.add(new Enemy(xPosition, yPosition, null)); //TODO: objects vs tiles
				else if(values[x][y] == 9) tiles[x][y] = new Flag(xPosition, yPosition, tileSize, tileset.getImage("Flag"), this);
				else if(values[x][y] == 10) tiles[x][y] = new Tile(xPosition, yPosition, tileSize, tileset.getImage("Flower1"), false, this);
				else if(values[x][y] == 11) tiles[x][y] = new Tile(xPosition, yPosition, tileSize, tileset.getImage("Flower2"), false, this);
			}
		}
